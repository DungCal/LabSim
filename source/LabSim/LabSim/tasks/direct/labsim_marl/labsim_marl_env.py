...
from .labsim_marl_env_cfg import LabsimMarlEnvCfg


class LabsimMarlEnv(DirectMARLEnv):
    cfg: LabsimMarlEnvCfg

    def __init__(self, cfg: LabsimMarlEnvCfg, render_mode: str | None = None, **kwargs):
